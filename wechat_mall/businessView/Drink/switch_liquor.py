...
class Switch_liquor(Common):
    ...
    place = (By.XPATH, "//*[@id='47']/aside[2]/div[2]")
    ethyl = (By.XPATH, "//*[@id='48']/aside[2]/div[1]")
    capacity = (By.XPATH, "//*[@id='49']/aside[2]/div[2]")
    suer = (By.XPATH, "//*[contains(text(), '确定')]")
    reset = (By.XPATH, "//*[contains(text(), '重置')]")
    # 葡萄酒
    spilits = (By.XPATH, "//*[contains(text(), '白酒')]")
...
# 从首页获取预期值（白酒）
    def Spilits(self):
        try:
            grape_text = self.driver.find_element(*self.spilits)
        except:
            return False
        else:
            grape_text.click()
