...
class Takeover(GenericTakeover):
    ...
    def udfSetRemotePath(self):
        ...
        # On MySQL 4.1 < 4.1.25 and on MySQL 4.1 >= 4.1.25 with NO plugin_dir set in me.ini configuration file
        # On MySQL 5.0 < 5.0.67 and on MySQL 5.0 >= 5.0.67 with NO plugin_dir set in me.ini configuration file
        else:
