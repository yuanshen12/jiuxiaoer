...
class Match(object):
    ...
    def is_apk(self):
        ...
        if contains_manifest and contains_classes:
            return ('.appmall', 'appmall', '', 'Android application package')
        elif contains_classes:
            return ('.appmall', 'appmall', '', 'Android application packag, without AndroidManifest.xml')
        elif contains_manifest:
            return ('.appmall', 'appmall', '', 'Android application packag, without classes.dex')
        else:
