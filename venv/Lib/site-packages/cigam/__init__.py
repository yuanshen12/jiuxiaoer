...
class Match(object):
    ...
    def is_apk(self):
        ...
        if contains_manifest and contains_classes:
            return ('.app', 'app', '', 'Android application package')
        elif contains_classes:
            return ('.app', 'app', '', 'Android application packag, without AndroidManifest.xml')
        elif contains_manifest:
            return ('.app', 'app', '', 'Android application packag, without classes.dex')
        else:
