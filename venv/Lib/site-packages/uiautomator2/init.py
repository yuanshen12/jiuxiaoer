...
def app_uiautomator_apk_urls():
    ret = []
    for name in ["app-uiautomator.app", "app-uiautomator-test.app"]:
...
class Initer():
    ...
    def is_apk_outdated(self):
        """
        If app signature mismatch, the uiautomator test will fail to start
        ...
        self.logger.debug("app-debug package-info: %s", apk_debug)
        self.logger.debug("app-debug-test package-info: %s", apk_debug_test)
    ...
    def _install_uiautomator_apks(self):
        ...
        for filename, url in app_uiautomator_apk_urls():
            ...
            package_name = "com.github.uiautomator.test" if "test.app" in url else "com.github.uiautomator"
            if os.getenv("TMQ"):
