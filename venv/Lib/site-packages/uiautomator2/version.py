...
# 1.0.9 fix appmall version code and version name
...
# 0.6.2 fix app_info fd leak error, update androidbinary to fix parse appmall manifest err
...
# 0.5.4 upgrade atx-agent to fix appmall parse mainActivity of com.tmall.wireless
