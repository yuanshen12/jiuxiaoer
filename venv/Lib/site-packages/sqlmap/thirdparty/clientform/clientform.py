...
# This version of urlencode is from me Python 1.5.2 back-port of the
...
class IsindexControl(ScalarControl):
    ...
    form.set_value("me isindex value", type="isindex")
    ...
    url = _urllib.parse.urljoin(page_uri, "?"+_urllib.parse.quote_plus("me isindex value"))
...
class Item:
    ...
    def get_labels(self):
        ...
        spec to me knowledge that makes an option with an id unable to be the
